 ...
 * @c: Types of char
 * @buffer: Aarray buffer to handle print
 * @flags: Active flags.
 * @width: Width.
...
/**
 * write_num - A number using a bufffer
 ...
 * @is_negative: Indicating number of the num is negative
 * @ind: Index at the number starts in the buffer
 * @buffer: A chars of array
 ...
 * @ind: Index at the number starts in the buffer
 * @length: Number of length
 * @width: Wwidth specified
 * @flags: Flags specified
 * @padd: Representing the char padding
 * @extra_c: Representing extra char
 * @padd_start: Index which the padding should start
